...
func (game Game) AddToPile(cards []Card) {
	...
	for i, play := range *game.pile {
		log.Printf("%d: %s", i, StringifyCards(play))
	}
	log.Println("---PILE END---")
}

func PlayMove(game *Game) func(cards []Card) error {
